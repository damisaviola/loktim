  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 mb-24 sm:mb-12">
        ...
        <div className="flex items-center justify-between gap-3 text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium">
          <Link
            href="/jobs"
            className="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors font-bold group"
          >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-6 sm:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5">
            <div className="flex items-start gap-4 min-w-0 flex-1">
              ...
              {/* Company Logo */}
              <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200/90 dark:border-slate-700/80 flex items-center justify-center overflow-hidden shrink-0 shadow-2xs">
                {(job.imageUrl || job.company?.logoUrl) ? (
                  ...
                  <Building2 className="w-7 h-7 text-slate-300 dark:text-slate-500" />
                )}
              </div>
              ...
              <div className="space-y-1.5 min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <Link
                    ...
                    className="font-bold text-xs sm:text-sm text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors flex items-center gap-1"
                  >
                    <span>{job.company?.name}</span>
                  </Link>

                  <span className="bg-emerald-50 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 px-2 py-0.5 rounded-full text-[10px] font-bold flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3 text-emerald-600 dark:text-emerald-400 shrink-0" /> Terverifikasi
                  </span>

                  {isPremium && (
                    <span className="bg-amber-50 dark:bg-amber-950/80 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800 px-2 py-0.5 rounded-full text-[10px] font-bold flex items-center gap-1">
            ...
            <div className="hidden sm:flex items-center gap-2 shrink-0">
              ...
              <ShareButton title={job.title} className="rounded-xl w-11 h-11 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 shadow-2xs" />
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1 text-xs text-slate-600 dark:text-slate-400">
            {salary && (
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 font-bold border border-emerald-200/80 dark:border-emerald-800 text-xs">
                <Banknote className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" />
                <span>{salary}</span>
              </span>
            )}

            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/70 dark:border-slate-700/60 text-slate-700 dark:text-slate-300 font-medium">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/70 dark:border-slate-700/60 text-slate-500 dark:text-slate-400 font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-6 sm:p-8 space-y-6">
              ...
              <div
                className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed prose prose-slate dark:prose-invert max-w-none prose-p:mb-3 prose-ul:mb-3 prose-li:my-1 prose-strong:font-bold break-words"
                  ...
                  <div className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed space-y-2">
                    {(Array.isArray(job.requirements)
                      ...
                      if (numberMatch) {
                        return (
                          <div key={i} className="flex items-start gap-2.5 leading-relaxed">
                            <span className="font-semibold text-slate-700 dark:text-slate-300 shrink-0 min-w-[20px]">{numberMatch[1]}</span>
            ...
            {/* Anti-Fraud Banner */}
            <div className="rounded-2xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-800/60 p-5 space-y-1.5 text-amber-900 dark:text-amber-200">
              <div className="font-bold text-xs sm:text-sm flex items-center gap-2 text-amber-800 dark:text-amber-300">
          ...
          <aside className="lg:col-span-4 space-y-6 sticky top-24">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-6 space-y-4">
              <h2 className="font-bold text-xs text-slate-400 dark:text-slate-500 uppercase tracking-wider font-mono">Tentang Perusahaan</h2>

              <div className="flex items-start gap-3.5">
                <div className="w-12 h-12 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center shrink-0 rounded-xl shadow-2xs relative overflow-hidden">
                  {(job.imageUrl || job.company?.logoUrl) ? (
                    <Image
                      src={(job.imageUrl || job.company?.logoUrl) as string}
                      alt={job.company?.name || "Company Logo"}
                ...
                <div className="min-w-0 flex-1">
                  <Link href={`/perusahaan/${job.companyId || job.company?.id || ''}`} className="font-bold hover:text-primary dark:hover:text-primary transition-colors text-slate-900 dark:text-slate-100 text-sm leading-snug block truncate">
                    {job.company?.name}
                  </Link>
                  <span className="text-xs font-medium text-slate-400 dark:text-slate-500 block truncate mt-0.5">{job.company?.location || 'Timika'}</span>
                </div>
              </div>
              ...
              <Link href={`/perusahaan/${job.companyId || job.company?.id || ''}`} className="block w-full">
                <button className="w-full h-10 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 font-bold rounded-xl transition-all text-xs shadow-2xs flex items-center justify-center gap-1.5 cursor-pointer">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs p-6 space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-xs text-slate-400 dark:text-slate-500 uppercase tracking-wider font-mono">Lowongan Serupa</h2>
              ...
              <div className="flex flex-col gap-3">
                {jobs
                  ...
                  .slice(0, 4)
                  .map(relatedJob => (
                    <Link key={relatedJob.id} href={`/job/${relatedJob.id}`} className="group flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-100 dark:hover:border-slate-800 transition-all">
                      <div className="w-10 h-10 shrink-0 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center overflow-hidden rounded-xl mt-0.5 shadow-2xs relative">
                        {relatedJob.company?.logoUrl ? (
                          ...
                          <Building2 className="w-4 h-4 text-slate-300 dark:text-slate-500" />
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-slate-900 dark:text-slate-100 group-hover:text-primary dark:group-hover:text-primary transition-colors text-xs leading-snug truncate mb-0.5">{relatedJob.title}</h3>
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 font-medium truncate">{relatedJob.company?.name}</div>
                        <div className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 flex items-center gap-1 truncate mt-0.5">
        ...
        <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200/80 dark:border-slate-800 p-3 flex flex-row gap-2 z-50 shadow-lg pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
          ...
          <ShareButton title={job.title} className="rounded-xl w-11 h-11 shrink-0 relative bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300" />
          <JobMoreOptions jobId={job.id} />
        </div>
